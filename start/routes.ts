...
router
  .group(() => {
    ...
    router
      .put('notifications', [AdminAuthController, 'updateNotifications'])
...
router
  .group(() => {
    ...
    router
      .post('verify-totp', [ClientAuthController, 'verifyTotp'])
      .use([middleware.clientAuth(), middleware.rateLimiter()])
...
router
  .group(() => {
    ...
    router.post('reverse-sync', [MicrosoftOAuthController, 'reverseSync'])
...
router
  .group(() => {
    ...
    router
      .on('/admin/demandes-rdv')
      .renderInertia('admin/demandes-rdv/index')
      .as('admin.demandes-rdv')
...
router
  .group(() => {
    router
      .on('/espace-client/dashboard')
      .renderInertia('client/dashboard/index')
      .as('client.dashboard')
    router
      .on('/espace-client/dossiers')
      .renderInertia('client/dossiers/index')
      .as('client.dossiers')
    router
      .on('/espace-client/dossiers/:id')
      .renderInertia('client/dossiers/show')
      .as('client.dossiers.show')
    router
      .on('/espace-client/demandes-rdv')
      .renderInertia('client/demandes-rdv/index')
      .as('client.demandes-rdv')
    router
      .on('/espace-client/parametres')
      .renderInertia('client/parametres/index')
      .as('client.parametres')
  })
  .use([middleware.clientAuth(), middleware.totpVerified()])
